  ...
  return (
    ...
    >
      <div className="relative mx-auto flex w-full max-w-5xl flex-col text-center">
        ...
        <div className="surface-kicker animate-fade-up mb-5 inline-flex max-w-full flex-wrap items-center justify-center gap-2 self-center rounded-full border border-zinc-200/95 bg-white px-1 py-1 pl-3 pr-1 ring-1 ring-zinc-900/[0.07] sm:mb-8 md:mb-10">
